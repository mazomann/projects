...
class LeadAssessment(BaseModel):
    ...
    summary: str = Field(min_length=20, max_length=600, description="3 lines: what they do, who for, any signal of scale")
    fit_score: int = Field(ge=1, le=10)
    fit_reasons: list[str] = Field(min_length=1, max_length=4)
    opener: str = Field(min_length=20, max_length=400, description="one personalised sentence referencing something specific on their site")
